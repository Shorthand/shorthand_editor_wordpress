...
export function EditButton({ url }: IEditButtonProps): JSX.Element {
  return (
    <button
    ...
    >
      <a className={styles.editButtonLink} href={url}>
        <div className={styles.editButtonContainer}>
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 107 107" xmlSpace="preserve">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              fill="#F1F2F2"
              d="M53.5,0C23.952,0,0,23.953,0,53.5C0,83.046,23.952,107,53.5,107
